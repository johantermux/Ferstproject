...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/johantermux/Ferstproject/archive/dev.zip"
        dir_name = "TBomb-dev"
    else:
        zip_url = "https://github.com/johantermux/Ferstproject/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/johantermux/Ferstproject.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/johantermux/Ferstproject.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/johantermux/Ferstproject/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/johantermux/Ferstproject/raw/dev/.notify"
        else:
            url = "https://github.com/johantermux/Ferstproject/raw/master/.notify"
